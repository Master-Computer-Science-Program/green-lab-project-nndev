...
if __name__ == "__main__":
    ...
    for i in looper:
        ...
        print(rankine_to_kelvin(i[0],i[1]))
        print(reaumur_to_celsius(i[0],i[1]))
        print(reaumur_to_fahrenheit(i[0],i[1]))
        print(reaumur_to_kelvin(i[0],i[1]))
        print(reaumur_to_rankine(i[0],i[1]))
        print(celsius_to_fahrenheit(i[0],i[1]))
        print(celsius_to_kelvin(i[0],i[1]))
        print(celsius_to_rankine(i[0],i[1]))
        print(fahrenheit_to_celsius(i[0],i[1]))
        print(fahrenheit_to_kelvin(i[0],i[1]))
        print(fahrenheit_to_rankine(i[0],i[1]))
        print(kelvin_to_celsius(i[0],i[1]))
        print(kelvin_to_fahrenheit(i[0],i[1]))
        print(kelvin_to_rankine(i[0],i[1]))
