...
C8_ARG = [["".join([chr((i + j) % 26 + 97) for j in range(9)]), [chr((i + k) % 26 + 97) + chr((i + k + 1) % 26 + 97) + chr((i + k + 2) % 26 + 97) for k in range(6)]] for i in range(0, 100000,2)]#Elapsed Time: 30.87672758102417 seconds
C9_ARG = [list(range(0, i)) + list(range(i-2, -1, -1)) for i in range(5, 500)] #Elapsed time: 40.16234993934631 seconds
