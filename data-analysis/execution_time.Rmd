...
wilcox_results_effsize <- map_dfr(guidelines, function(g) {
  ...
  no_guideline_j <- subset_data %>% dplyr::filter(treatment == "no_guideline") %>% pull(execution_time)
  guideline_j     <- subset_data %>% dplyr::filter(treatment == "guideline") %>% pull(execution_time)
